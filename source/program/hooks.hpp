...
{
	// Main Function Hook
	SortArmorPouch::InstallAtOffset(
		sort::helpers::GetAppVersionOffset(sort::s_sortArmorPouchOffsets));

	SetArraySizeX9::InstallAtOffset(
		sort::helpers::GetAppVersionOffset(sort::s_setArraySizeX9Offsets));

	SetArraySizeW8::InstallAtOffset(
		sort::helpers::GetAppVersionOffset(sort::s_setArraySizeW8Offsets));

	SetDoubleArraySizeW8::InstallAtOffset(
		sort::helpers::GetAppVersionOffset(sort::s_setDoubleArraySizeW8Offsets));

	SetArmorSortInfoX8::InstallAtOffset(
		sort::helpers::GetAppVersionOffset(sort::s_setArmorSortInfoX8Offsets));

	SetArmorSortInfoPtrX8::InstallAtOffset(
		sort::helpers::GetAppVersionOffset(sort::s_setArmorSortInfoPtrX8Offsets));

	SetSortInfoX8::InstallAtOffset(
		sort::helpers::GetAppVersionOffset(sort::s_setSortInfoX8Offsets));

	SetDoubleSortInfoX8::InstallAtOffset(
		sort::helpers::GetAppVersionOffset(sort::s_setDoubleSortInfoX8Offsets));
}